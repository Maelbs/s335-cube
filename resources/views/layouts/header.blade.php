...
<<<<<<< HEAD
    ...
    <div class="menu-user">
        ...
        <div class="icone">
            ...
            {{-- DÉBUT DE LA MODIFICATION MINI-PANIER --}}
            <div class="cart-dropdown-wrapper">
                <a id="panier" href="{{ route('cart.index') }}">
                    ...
                    {{-- Badge optionnel si tu as une variable count --}}
                    @if(isset($cartItems) && count($cartItems) > 0)
                        <span
                            style="position:absolute; top:-5px; right:-5px; background:red; color:white; border-radius:50%; width:16px; height:16px; font-size:10px; display:flex; justify-content:center; align-items:center;">{{ count($cartItems) }}</span>
                    @endif
                </a>
                ...
                <div class="cart-preview-box">
                            ...
                            @foreach($cartItems as $item)
                                <div class="cart-item">
                                    <div class="cart-item-img">
                                        {{-- On utilise la syntaxe tableau $item['image'] --}}
                                        <img src="{{ isset($item['image']) ? asset('storage/' . $item['image']) : 'https://via.placeholder.com/80' }}"
                                            alt="{{ $item['name'] ?? 'Produit' }}">
                                    </div>
                                    <div class="cart-item-details">
                                        <span class="item-name">
                                            {{ $item['name'] }}
                                            {{-- Pareil ici : $item['quantity'] --}}
                    ...
                    <div class="cart-footer">
                        <div class="cart-total-row">
                            ...
                            <span class="price">
                                {{ isset($cartTotal) ? number_format($cartTotal, 2, ',', ' ') : '0,00' }} € TTC
                            </span>
                        </div>
            ...
            {{-- FIN DE LA MODIFICATION MINI-PANIER --}}
