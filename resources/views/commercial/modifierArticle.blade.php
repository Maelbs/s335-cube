...
<body>
    <div class="catalog-container">
        ...
        <div class="header-section">
            ...
            <p style="color: #666; margin-top: 5px;">Modifiez ou supprimez les références existantes.</p>
        </div>
        ...
        <div id="tab-velos" class="tab-content active">
            <div class="products-grid">
                @forelse($velosMusculaires as $article)
                    ...
                    @include('commercial.layoutsCommercial.cards', ['article' => $article, 'dossier' => 'VELOS'])
                @empty
                    @endforelse
            </div>
        </div>
        ...
        <div id="tab-accessoires" class="tab-content">
            <div class="products-grid">
                @forelse($accessoires as $article)
                    ...
                    @include('commercial.layoutsCommercial.cards', ['article' => $article, 'dossier' => 'ACCESSOIRES'])
                @empty
                    @endforelse
            </div>
        </div>
