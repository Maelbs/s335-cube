...
<body>
    <div class="catalog-container">
        ...
        <div class="header-section">
            <h1 class="page-title">Gestion des caracteristiques du Catalogue</h1>
            <p style="color: #666; margin-top: 5px;">Ajouter Caracteristiques.</p>
        </div>
        ...
        <div id="tab-velos" class="tab-content active">
            <div class="products-grid">
                @forelse($velosMusculaires as $article)
                    ...
                    @include('commercial.layoutsCommercial.cardsCaracteristique', ['article' => $article, 'dossier' => 'VELOS'])
                @empty
                    @endforelse
            </div>
        </div>
        ...
        <div id="tab-accessoires" class="tab-content">
            <div class="products-grid">
                @forelse($accessoires as $article)
                    ...
                    @include('commercial.layoutsCommercial.cardsCaracteristique', ['article' => $article, 'dossier' => 'ACCESSOIRES'])
                @empty
                    @endforelse
            </div>
        </div>
