...
<body>
    ...
    <section id="wrapper" class="container" style="margin-top: 10rem">
        <div class="row justify-content-center">
            <div id="content-wrapper" class="col-12 col-lg-8"> <section class="register-form text-center">
                    ...
                    <form class="js-customer-form needs-validation card card-account text-left"
                        ...
                        <div id="address-section">
                            ...
                            <section class="form-fields">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" name="rue" type="text" value="{{ old('rue') }}" id="rue" required placeholder="Ex: 10 rue de la paix...">
                                </div>

                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        <label class="required font-weight-bold" for="zipcode">Code postal </label>
                                        <input class="form-control" name="zipcode" type="text" value="{{ old('zipcode') }}" id="zipcode" required  style="background-color: #e9ecef;">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="required font-weight-bold" for="city">Ville </label>
                                        <input class="form-control" name="city" type="text" value="{{ old('city') }}" id="city" required  style="background-color: #e9ecef;">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="required font-weight-bold" for="country">Pays </label>
                                    <input class="form-control" name="country" type="text" value="{{ old('country') }}" id="country" required  style="background-color: #e9ecef;">
                                </div>
                            </section>

                            <div class="form-group mt-3">
                                <label class="custom-toggle-container" for="use_same_address">
                            ...
                            <div id="billing-address-wrapper">
                                ...
                                <section class="form-fields">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="billing_rue" type="text" value="{{ old('billing_rue') }}" id="billing_rue" placeholder="Rechercher une adresse...">
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6 form-group">
                                            <label class="required font-weight-bold" for="billing_zipcode">Code postal </label>
                                            <input class="form-control" name="billing_zipcode" type="text" value="{{ old('billing_zipcode') }}" id="billing_zipcode"  style="background-color: #e9ecef;">
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label class="required font-weight-bold" for="billing_city">Ville </label>
                                            <input class="form-control" name="billing_city" type="text" value="{{ old('billing_city') }}" id="billing_city"  style="background-color: #e9ecef;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="required font-weight-bold" for="billing_country">Pays </label>
                                        <input class="form-control" name="billing_country" type="text" value="{{ old('billing_country') }}" id="billing_country"  style="background-color: #e9ecef;">
                                    </div>
                                </section>
                            </div>
